...
/**
 * ResetPersonalDetails2Activity enables the User to reset his/her personal details.
 * NOTE: This option is currently not offered in the app functionality.
 */

public class ResetPersonalDetails2Activity extends AppCompatActivity {
    /**
     * Instance variables
     */
    private EditText allergiesInput, likeInput, dontlikeInput;

    /**
     * onCreate sets the corresponding ContentView and makes the EditText fields
     * available for use.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myprofile_resetpersonaldetails2);

        allergiesInput = (EditText) findViewById(R.id.RPallergiesInput);
        likeInput = (EditText) findViewById(R.id.RPlikeInput);
        dontlikeInput = (EditText) findViewById(R.id.RPdontlikeInput);
    }
    ...
    protected void doneOnClick(View view){
        // TODO update the personalDetails2
        startActivity(new Intent(this, CaloryIntakeActivity.class));
        finish();
    }
}
