...
/**
 * NutritionstatisticsGeneralInfoActivity provides a general info text on nutrition.
 */

public class NutritionstatisticsGeneralInfoActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nutritionstatistics_generalinfo);
    }
